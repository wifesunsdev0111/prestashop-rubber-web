			...
			else
			{
				...
				if($this->getRecordByOrder())
				{
					...
					else
					{
						...
						$oIdeal->setValue('declineurl', idealcheckout_getRootUrl(1) . 'idealcheckout/return.php?order_id=' . $this->oRecord['order_id'] . '&order_code=' . $this->oRecord['order_code'] . '&status=CANCELLED'); // Failure URL
						$oIdeal->setValue('exceptionurl', idealcheckout_getRootUrl(1) . 'idealcheckout/return.php?order_id=' . $this->oRecord['order_id'] . '&order_code=' . $this->oRecord['order_code'] . '&status=CANCELLED'); // Failure URL
						$oIdeal->setValue('cancelurl', idealcheckout_getRootUrl(1) . 'idealcheckout/return.php?order_id=' . $this->oRecord['order_id'] . '&order_code=' . $this->oRecord['order_code'] . '&status=CANCELLED'); // Cancelled URL
						$oIdeal->setValue('backurl', idealcheckout_getRootUrl(1) . 'idealcheckout/return.php?order_id=' . $this->oRecord['order_id'] . '&order_code=' . $this->oRecord['order_code'] . '&status=CANCELLED'); // Cart/Checkout URL
