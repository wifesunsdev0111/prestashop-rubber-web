<?php
	...
	class TP_Ideal
	{
		...
		protected $sLanguageCode = 'NL';
		protected $sCountryCode = 'NL';
		protected $sCurrencyCode = 'EUR';

		public function __construct($sLayoutCode, $sLanguageCode = 'NL', $sCountryCode = 'NL', $sCurrencyCode = 'EUR')
		{
			if($sLayoutCode)
			{
		...
		public function doTransactionRequest($sBankId, $fAmount, $sDescription = '', $sReturnUrl = '', $sReportUrl = '')
		{
			$aParams = array();
			...
			$sPostUrl = 'https://www.targetpay.com/ideal/start.php';
		...
		public function doStatusRequest($sTransactionId, $bOnce = true, $bTest = false)
		{
			...
			$sPostUrl = 'https://www.targetpay.com/ideal/check.php';
			$sPostData = $this->paramsToString($aParams);
