		...
		public function doSetup()
		{
			...
			else
			{
				...
				if($this->getRecordByOrder())
				{
					...
					{
						$oOmniKassa = new OmniKassa('mistercash');
						...
						$sHtml = '<p><b>' . idealcheckout_getTranslation(false, 'idealcheckout', 'Checkout with {0}', array('MisterCash')) . '</b></p>' . $oOmniKassa->createForm();
