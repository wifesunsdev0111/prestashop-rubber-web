			...
			else
			{
				...
				if($this->getRecordByOrder())
				{
					...
					else
					{
						...
						{
							// Webshop settings
							$oIdeal->setValue('accepturl', idealcheckout_getRootUrl(1) . 'idealcheckout/return.php?order_id=' . urlencode($this->oRecord['order_id']) . '&order_code=' . $this->oRecord['order_code'] . '&status=SUCCESS'); // Success/pending URL
							$oIdeal->setValue('declineurl', idealcheckout_getRootUrl(1) . 'idealcheckout/return.php?order_id=' . urlencode($this->oRecord['order_id']) . '&order_code=' . $this->oRecord['order_code'] . '&status=FAILURE'); // Failure URL
							$oIdeal->setValue('exceptionurl', idealcheckout_getRootUrl(1) . 'idealcheckout/return.php?order_id=' . urlencode($this->oRecord['order_id']) . '&order_code=' . $this->oRecord['order_code'] . '&status=FAILURE'); // Failure URL
							$oIdeal->setValue('cancelurl', idealcheckout_getRootUrl(1) . 'idealcheckout/return.php?order_id=' . urlencode($this->oRecord['order_id']) . '&order_code=' . $this->oRecord['order_code'] . '&status=CANCELLED'); // Cancelled URL
							$oIdeal->setValue('backurl', idealcheckout_getRootUrl(1) . 'idealcheckout/return.php?trxid=' . $this->oRecord['transaction_id'] . '&ec=' . $this->oRecord['transaction_code'] . '&status=CANCELLED'); // Cart/Checkout URL
							$oIdeal->setValue('homeurl', idealcheckout_getRootUrl(1) . 'idealcheckout/return.php?trxid=' . $this->oRecord['transaction_id'] . '&ec=' . $this->oRecord['transaction_code'] . '&status=CANCELLED'); // Homepage URL
							$oIdeal->setValue('catalogurl', idealcheckout_getRootUrl(1) . 'idealcheckout/return.php?trxid=' . $this->oRecord['transaction_id'] . '&ec=' . $this->oRecord['transaction_code'] . '&status=CANCELLED'); // Catalog URL
						}
