			...
			else
			{
				...
				if($this->getRecordByOrder())
				{
					...
					else
					{
						...
						$aUrl = parse_url(strtolower(idealcheckout_getRootUrl(1)));
						...
						$oApi->setParam('psp_code', '105'); // Authorized Payment (Eenmalige machtiging/Automatische incasso/Acceptgiro)
						...
						if(!empty($this->oRecord['order_params']))
						{
							...
							{
								$oApi->setParam('consumer_phone', $aOrderParams['customer']['payment_phone']);
							}
