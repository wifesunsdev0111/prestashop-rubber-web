		...
		public function doSetup()
		{
			...
			else
			{
				...
				if($this->getRecordByOrder())
				{
					...
					{
						$oOmniKassa = new OmniKassa('authorizedtransfer');
						...
						$sHtml = '<p><b>' . idealcheckout_getTranslation(false, 'idealcheckout', 'Checkout with {0}', array('Eenmalige Machtiging')) . '</b></p>' . $oOmniKassa->createForm();
