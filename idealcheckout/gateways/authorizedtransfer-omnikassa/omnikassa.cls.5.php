	...
	*/
	...
	class OmniKassa
	{
		...
		public function createForm()
		{
			...
			if(in_array($this->sPaymentType, array('authorizedtransfer', 'ideal', 'minitix', 'mistercash', 'transactionform')))
			{
			...
			if(in_array($this->sPaymentType, array('authorizedtransfer')))
			{
				$aData['paymentMeanBrandList'] = 'INCASSO';
			}
			elseif(in_array($this->sPaymentType, array('cashondelivery')))
			{
				$aData['paymentMeanType'] = 'REMBOURS';
			}
			elseif(in_array($this->sPaymentType, array('creditcard')))
			{
			...
			elseif(in_array($this->sPaymentType, array('maestro')))
			{
				$aData['paymentMeanBrandList'] = 'MAESTRO';
			}
			elseif(in_array($this->sPaymentType, array('mastercard')))
			{
				$aData['paymentMeanBrandList'] = 'MASTERCARD';
			}
			...
			{
				$aData['paymentMeanBrandList'] = 'BCMC';
			}
			elseif(in_array($this->sPaymentType, array('paypal')))
			{
				$aData['paymentMeanBrandList'] = 'PAYPAL';
			}
			elseif(in_array($this->sPaymentType, array('transactionform')))
			{
				$aData['paymentMeanBrandList'] = 'ACCEPTGIRO';
			}
			elseif(in_array($this->sPaymentType, array('visa')))
			{
				$aData['paymentMeanBrandList'] = 'VISA';
			}
			elseif(in_array($this->sPaymentType, array('vpay')))
			{
				$aData['paymentMeanBrandList'] = 'VPAY';
			}
