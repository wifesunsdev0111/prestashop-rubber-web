		...
		public function doSetup()
		{
			...
			else
			{
				...
				if($this->getRecordByOrder())
				{
					...
					{
						$oOmniKassa = new OmniKassa('transactionform');
						...
						$sHtml = '<p><b>' . idealcheckout_getTranslation(false, 'idealcheckout', 'Checkout with {0}', array('Acceptgiro')) . '</b></p>' . $oOmniKassa->createForm();
