		...
		public function doSetup()
		{
			...
			else
			{
				...
				if($this->getRecordByOrder())
				{
					...
					{
						$oOmniKassa = new OmniKassa('mastercard');
						...
						$sHtml = '<p><b>' . idealcheckout_getTranslation(false, 'idealcheckout', 'Checkout with {0}', array('MasterCard')) . '</b></p>' . $oOmniKassa->createForm();
