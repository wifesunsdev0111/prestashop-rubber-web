<?php
	...
	class IDEALCHECKOUT_FOR_PRESTASHOP_1_5
	{
		...
		public static function getInstructions($aSettings)
		{
			...
			$sHtml .= '<li>Klik in het hoofdmenu op Modules en scroll naar beneden.<br>Hier vindt u alle toegevoegde betaalmethoden terug.</li>';
