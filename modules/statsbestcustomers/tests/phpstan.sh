...
docker exec -t temp-ps rm -rf /var/www/html/modules/statsbestcustomers
...
docker run --rm --volumes-from temp-ps \
       -v $PWD:/var/www/html/modules/statsbestcustomers \
       -e _PS_ROOT_DIR_=/var/www/html \
       --workdir=/var/www/html/modules/statsbestcustomers phpstan/phpstan:0.12 \
       analyse \
       --configuration=/var/www/html/modules/statsbestcustomers/tests/phpstan/phpstan-$PS_VERSION.neon
