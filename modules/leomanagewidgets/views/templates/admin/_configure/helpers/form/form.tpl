                    ...
                    <div class="static-content col-lg-12">
                        <div class="top-container static-container">
                            {if isset($leo_group_list[$input.name]) && isset($leo_group_list[$input.name]["0"])}
                                {include file="$leo_tpl_group" type="0" hook_name=$input.name item_group=$leo_group_list[$input.name]["0"]["0"]}
                            {else}
                                {include file="$leo_tpl_group" type="0" hook_name=$input.name}
                            {/if}
                        </div>
                    </div>
                </div>
                            ...
                            <div class="group-list" data-hook="{$input.name}">
                                {if isset($leo_group_list[$input.name]) && isset($leo_group_list[$input.name]["1"])}
                                    {foreach $leo_group_list[$input.name]["1"] item=itemGroup}
                                        {include file="$leo_tpl_group" type="1" hook_name=$input.name item_group=$itemGroup}
                                    {/foreach}
                                {/if}
                            </div>
                        </div>
                    ...
                    <div class="static-content col-lg-12">
                        <div class="bottom-container static-container">
                            {if isset($leo_group_list[$input.name]) && isset($leo_group_list[$input.name]["2"])}
                                {include file="$leo_tpl_group" type="2" hook_name=$input.name item_group=$leo_group_list[$input.name]["2"]["0"]}
                            {else}
                                {include file="$leo_tpl_group" type="2" hook_name=$input.name}
                            {/if}
                        </div>
                    </div>
                </div>            
