...
<p class="payment_module ogone-sub-payment" id="ogone_sub_block">
  <a onclick="document.forms['ogone_form_subscription'].submit(); return false;" href="#" title="{l s='Pay with Ingenico ePayments' mod='ogone'}">
...
<form name="ogone_form_subscription" action="{$action|escape:'htmlall':'UTF-8'}" method="{$method|escape:'htmlall':'UTF-8'}">
