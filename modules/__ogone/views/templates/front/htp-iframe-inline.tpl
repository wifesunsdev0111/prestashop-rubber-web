...
<div class="row alias_block">
  <div class="col-xs-12">
    <div class="payment_module">
      <img src='{$content_dir|escape:'htmlall':'UTF-8'}modules/ogone/views/img/{$type_class|escape:'htmlall':'UTF-8'}.png' class="ogone_htp_logo" style="max-width: 64px">
      <div class="ogone">
        ...
        {/if}
        <div class="alias_holder_{$type_class|escape:'htmlall':'UTF-8'}" style="display:none">
...
<script  defer="defer">
 ...
 {literal}
    $(".alias_trigger_{/literal}{$type_class|escape:'htmlall':'UTF-8'}{literal}").click(function(){
      if ($(".alias_holder_{/literal}{$type_class|escape:'htmlall':'UTF-8'}{literal}:visible").length == 1){
         $(".alias_trigger_{/literal}{$type_class|escape:'htmlall':'UTF-8'}{literal}").text(alias_holder_hidden_txt);
         $(".alias_holder_{/literal}{$type_class|escape:'htmlall':'UTF-8'}{literal}").hide();
      } else {
         $(".alias_trigger_{/literal}{$type_class|escape:'htmlall':'UTF-8'}{literal}").text(alias_holder_displayed_txt);
         $(".alias_holder_{/literal}{$type_class|escape:'htmlall':'UTF-8'}{literal}").show();
      }
    });
  });
{/literal}
