...
<p class="payment_module">
  <a onclick="document.forms['ogone_form'].submit(); return false;" href="#" title="{l s='Pay with Ingenico ePayments' mod='ogone'}">
    <img src="{$default_option_logo|escape:'htmlall':'UTF-8'}" alt="{l s='Ingenico ePayments logo' mod='ogone'}" style="padding-right: 2px; width: 86px; height: 49px"/>
    {if isset($default_option_name) && $default_option_name}
      {$default_option_name|escape:'htmlall':'UTF-8'}
    {else}
      {l s='Pay with Ingenico ePayments' mod='ogone'} ({l s='Pay safely on the next page with Ingenico ePayments using your preferred payment method' mod='ogone'})</span>
    {/if}
  </a>
</p>
