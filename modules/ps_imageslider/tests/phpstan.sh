...
docker exec -t temp-ps rm -rf /var/www/html/modules/ps_imageslider
...
docker run --rm --volumes-from temp-ps \
       -v $PWD:/var/www/html/modules/ps_imageslider \
       -e _PS_ROOT_DIR_=/var/www/html \
       --workdir=/var/www/html/modules/ps_imageslider phpstan/phpstan:0.12 \
       analyse \
       --configuration=/var/www/html/modules/ps_imageslider/tests/phpstan/phpstan-$PS_VERSION.neon
