...
docker exec -t temp-ps rm -rf /var/www/html/modules/statsbestsuppliers
...
docker run --rm --volumes-from temp-ps \
       -v $PWD:/var/www/html/modules/statsbestsuppliers \
       -e _PS_ROOT_DIR_=/var/www/html \
       --workdir=/var/www/html/modules/statsbestsuppliers phpstan/phpstan:0.12 \
       analyse \
       --configuration=/var/www/html/modules/statsbestsuppliers/tests/phpstan/phpstan-$PS_VERSION.neon
