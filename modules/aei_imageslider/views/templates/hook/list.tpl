...
<div class="panel"><h3><i class="icon-list-ul"></i> {l s='Slides list' d='Modules.ImageSlider'}
	<span class="panel-heading-action">
		<a id="desc-product-new" class="list-toolbar-btn" href="{$link->getAdminLink('AdminModules')}&configure=aei_imageslider&addSlide=1">
						...
						<div class="col-md-8">
							...
							<div class="btn-group-action pull-right">
								...
								<a class="btn btn-default"
									href="{$link->getAdminLink('AdminModules')}&configure=aei_imageslider&id_slide={$slide.id_slide}">
									<i class="icon-edit"></i>
									{l s='Edit' d='Admin.Actions'}
								</a>
								<a class="btn btn-default"
									href="{$link->getAdminLink('AdminModules')}&configure=aei_imageslider&delete_id_slide={$slide.id_slide}">
