...
class blockhtmlleftContentClass extends ObjectModel
{
	/** @var integer blockhtmlleftContent id*/
	public $id;
	
	/** @var integer blockhtmlleftContent id shop*/
	public $id_shop;
	...
	public static $definition = array(
		'table' => 'blockhtmlleftContent',
		'primary' => 'id_blockhtmlleftContent',
		'multilang' => true,
		'fields' => array(
	...
	{
		$id = Db::getInstance()->getValue('SELECT `id_blockhtmlleftContent` FROM `'._DB_PREFIX_.'blockhtmlleftContent` WHERE `id_shop` ='.(int)$id_shop);
		if ($id)
			return new blockhtmlleftContentClass((int)$id);
		else
			return false;
	}
