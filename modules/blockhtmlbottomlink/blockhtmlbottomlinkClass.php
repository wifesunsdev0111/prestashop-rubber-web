...
class blockhtmlbottomlinkClass extends ObjectModel
{
	/** @var integer blockhtmlbottomlink id*/
	public $id;
	
	/** @var integer blockhtmlbottomlink id shop*/
	public $id_shop;
	...
	public static $definition = array(
		'table' => 'blockhtmlbottomlink',
		'primary' => 'id_blockhtmlbottomlink',
		'multilang' => true,
		'fields' => array(
	...
	{
		$id = Db::getInstance()->getValue('SELECT `id_blockhtmlbottomlink` FROM `'._DB_PREFIX_.'blockhtmlbottomlink` WHERE `id_shop` ='.(int)$id_shop);
		if ($id)
			return new blockhtmlbottomlinkClass((int)$id);
		else
			return false;
	}
