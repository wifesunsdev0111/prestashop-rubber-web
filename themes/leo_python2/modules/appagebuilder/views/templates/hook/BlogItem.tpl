...
<div class="blog-container" itemscope itemtype="http://schema.org/Blog">
    ...
    <div class="right-block">
        ...
        <h5 class="blog-title" itemprop="title"><a href="{$blog.link}{*full url can not escape*}" title="{$blog.title|escape:'html':'UTF-8'}">{$blog.title|strip_tags:'UTF-8'|truncate:80:'...'}</a></h5>
        {/if}
        ...
        {/if}
		<p><a href="{$blog.link}" class="btn-links">{l s='Read more	' mod='appagebuilder'}<i class="fa fa-long-arrow-right"></i></a><p>
    </div>
</div>
