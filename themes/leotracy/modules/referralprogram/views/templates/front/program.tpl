...
<ul class="footer_links clearfix">
	...
	<li class="pull-right"><a class="btn btn-outline button button-small btn-sm" href="{$base_dir}" title="{l s='Home' mod='referralprogram'}"><span><i class="fa fa-home"></i>{l s='Home' mod='referralprogram'}</span></a></li>
</ul>
