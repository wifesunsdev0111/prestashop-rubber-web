...
{if $products}
    {if !$refresh}
        ...
        <p class="submit">
            <a id="showSendWishlist" class="btn btn-outline button button-small btn-sm" href="#" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" title="{l s='Send this wishlist' mod='blockwishlist'}">
