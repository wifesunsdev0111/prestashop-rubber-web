...
<div id="wishlist_block" class="block account">
	...
	<div class="block_content">
		...
		<div class="lnk">
			...
			{/if}
			<a class="btn btn-outline button button-small btn-sm" href="{$link->getModuleLink('blockwishlist', 'mywishlist', array(), true)|addslashes}" title="{l s='My wishlists' mod='blockwishlist'}">
				<span>
