...
<div class="blockcart_top clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if} col-lg-3 col-md-3 col-sm-3 col-xs-1 col-sp-12">
{/if}
	<div id="cart" class="shopping_cart">
		<div class="media heading clearfix">
			...
			<div class="cart-inner media-body clearfix">
