...
<form action="{$link->getModuleLink('cashondelivery', 'validation', [], true)|escape:'html'}" method="post">
	<div class="box">
        ...
        <h3 class="page-subheading"><span>{l s='Cash on delivery (COD) payment' mod='cashondelivery'}</span></h3>
        <p>
    ...
    <p class="cart_navigation" id="cart_navigation">
        ...
        <button type="submit" class="button btn btn-warning button-medium pull-right btn-outline"><span>{l s='I confirm my order' mod='cashondelivery'}</span></button>
    </p>
</form>
