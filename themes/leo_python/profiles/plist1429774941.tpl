...
<div class="leo-more-cdown" data-idproduct="{$product.id_product}"></div></div><div class="functional-buttons clearfix">
...
{if isset($comparator_max_item) && $comparator_max_item}
	<a class="add_to_compare" href="{$product.link|escape:'html':'UTF-8'}" data-id-product="{$product.id_product}"><span><i class="fa fa-refresh"></i></span></a>
{/if}
