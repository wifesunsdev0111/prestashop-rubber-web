...
$(function(){
    $('.btn_search').click(function() {
        if($('#search_block_top').hasClass('showsearch')){
            ...
            $('#topbar .abs-topbar').css({'z-index':'99'});
        }
        else{
             $('#search_block_top').addClass('showsearch');
             $('#topbar .abs-topbar').css({'z-index':'9'});
        }
    }); 
});
...
$(function(){
    $('.showmenu').click(function() {
        if($('#leo-megamenu').hasClass('active-menu')){
            $('#leo-megamenu').removeClass('active-menu');
        }
        else{
             $('#leo-megamenu').addClass('active-menu');
        }
    }); 
});
