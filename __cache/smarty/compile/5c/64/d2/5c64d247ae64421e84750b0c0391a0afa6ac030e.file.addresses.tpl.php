<?php /* Smarty version Smarty-3.1.19, created on 2022-06-28 19:29:56
         compiled from "/mnt/web017/a2/88/54052188/htdocs/Prestashop_02/themes/leo_python/addresses.tpl" */ ?>
<?php /*%%SmartyHeaderCode:210283489962bb3a94f1d971-16930116%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5c64d247ae64421e84750b0c0391a0afa6ac030e' => 
    array (
      0 => '/mnt/web017/a2/88/54052188/htdocs/Prestashop_02/themes/leo_python/addresses.tpl',
      1 => 1470857534,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '210283489962bb3a94f1d971-16930116',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62bb3a950b9f36_91203374',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62bb3a950b9f36_91203374')) {function content_62bb3a950b9f36_91203374($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/mnt/web017/a2/88/54052188/htdocs/Prestashop_02/tools/smarty/plugins/modifier.replace.php';
?>
...
"<?php }?>>
                ...
                <a class="btn btn-outline button button-small btn-sm" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['address']->value['object']['id']);?>
...
" class="btn btn-outline button button-medium"><span><?php echo smartyTranslate(array('s'=>'Add a new address'),$_smarty_tpl);?>
</span></a>
</div>
<ul class="footer_links clearfix">
	<li class="pull-left"><a class="btn btn-outline button button-small btn-sm" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('my-account',true), ENT_QUOTES, 'UTF-8', true);?>
"><span><i class="fa fa-user"></i> <?php echo smartyTranslate(array('s'=>'Back to your account'),$_smarty_tpl);?>
</span></a></li>
	<li class="pull-right"><a class="btn btn-outline button button-small btn-sm" href="<?php if (isset($_smarty_tpl->tpl_vars['force_ssl']->value)&&$_smarty_tpl->tpl_vars['force_ssl']->value) {?><?php echo $_smarty_tpl->tpl_vars['base_dir_ssl']->value;?>
<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['base_dir']->value;?>
<?php }?>"><span><i class="fa fa-home"></i> <?php echo smartyTranslate(array('s'=>'Home'),$_smarty_tpl);?>
</span></a></li>
</ul>
